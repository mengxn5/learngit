...
import com.czy.weather.pinyin.PinYin;
...
public class WeatherActivity extends Activity implements OnClickListener {
	...
	// 城市名
	private TextView county_name_text;
	// 天气描叙
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		county_name_text = (TextView) findViewById(R.id.county_name);
	...
	private void queryFromServer(final String county_name) {
		try {
			...
			String hhh=PinYin.getPingYin(county_name);
		    Log.i("hhhhhhhh", hhh);
	...
	private void showWeather() {
		county_name_text.setText(prefs.getString("county_name", "未知"));
		String s=prefs.getString("county_name", "未知");
		Log.i("aaa", s);
		...
		county_name_text.setVisibility(View.VISIBLE);
